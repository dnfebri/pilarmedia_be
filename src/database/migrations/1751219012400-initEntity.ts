...
export class InitEntity1751219012400 implements MigrationInterface {
    name = 'InitEntity1751219012400'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "comments_post" ("id" SERIAL NOT NULL, "content" text NOT NULL, "like" text NOT NULL, "post_id" integer, "author_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" character varying DEFAULT 'System', "updated_at" TIMESTAMP DEFAULT now(), "updated_by" TIMESTAMP, CONSTRAINT "PK_259bf9825d9d198608d1b46b0b5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "slug" character varying NOT NULL, "title" character varying NOT NULL, "content" text NOT NULL, "tags" text NOT NULL, "like" text NOT NULL, "author_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" character varying DEFAULT 'System', "updated_at" TIMESTAMP DEFAULT now(), "updated_by" TIMESTAMP, CONSTRAINT "UQ_54ddf9075260407dcfdd7248577" UNIQUE ("slug"), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
